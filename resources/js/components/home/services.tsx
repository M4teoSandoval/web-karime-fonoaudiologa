...
const services = [
    ...
    },
    {
        ...
        shortDescription:
            'Intervención dirigida a personas que presentan dificultades en la calidad, uso o resistencia de la voz.',
        details: [
            'Disfonías.',
            'Fatiga vocal.',
    ...
    },
    {
        ...
        shortDescription:
            'Atención dirigida a niños, adolescentes y adultos con dificultades en la comprensión y expresión del lenguaje.',
        details: [
    ...
    },
    {
        ...
        shortDescription:
            'Intervención para personas que presentan dificultades en la producción y claridad del habla.',
        details: [
    ...
    },
    {
        ...
        shortDescription:
            'Evaluación e intervención de dificultades para masticar y tragar alimentos, líquidos o saliva.',
        details: [
...
export function Services() {
    return (
        <section
            id="servicios"
            className="relative overflow-hidden bg-[#fcf9f7] py-24 sm:py-32"
        >
            {/* =========================================================
            ...
            {/* Soft pink glow */}
            <div
                className="pointer-events-none absolute -right-40 top-0 h-[450px] w-[450px] rounded-full bg-[#d99aa8]/8 blur-3xl"
                aria-hidden="true"
            />
            ...
            >
                ...
                <motion.svg
                    ...
                    className="absolute -right-[190px] top-[80px] hidden h-[560px] w-[560px] text-[#7d8f7a]/[0.09] lg:block"
                    viewBox="0 0 400 400"
                    fill="none"
                >
                    <path
                    ...
                    <path
                        d="M276 105C320 133 340 180 334 226C329 266 306 298 271 318"
                        stroke="currentColor"
                        strokeWidth="3"
                        strokeLinecap="round"
                    />
                ...
                <motion.svg
                    ...
                    className="absolute -left-[80px] bottom-[90px] h-[220px] w-[420px] text-[#d99aa8]/[0.09]"
                    viewBox="0 0 420 220"
                    fill="none"
                >
                    <path
                ...
                <motion.div
                    ...
                    className="absolute right-[28%] top-[18%] size-5 rounded-full border border-[#d99aa8]/20"
                />
                ...
                <motion.div
                    ...
                    className="absolute bottom-[18%] right-[12%] size-8 rounded-full border border-[#7d8f7a]/20"
                />

                <div className="absolute left-[13%] top-[20%] size-2 rounded-full bg-[#d99aa8]/20" />

                <div className="absolute right-[9%] top-[48%] size-2.5 rounded-full bg-[#7d8f7a]/20" />
            </div>
            ...
            <div className="relative mx-auto max-w-7xl px-5 sm:px-8 lg:px-12">
                ...
                >
                    ...
                    >
                        ...
                        <span className="text-[12px] font-bold tracking-[0.2em] text-[#7d8f7a] uppercase">
                            Servicios
                        </span>
                    ...
                    <motion.h2
                        variants={itemVariants}
                        className="text-4xl leading-tight font-normal tracking-[-0.03em] text-[#373432] sm:text-5xl"
                    >
                        Un acompañamiento
                    ...
                    <motion.p
                        variants={itemVariants}
                        className="mx-auto mt-5 max-w-xl text-base leading-7 text-[#706a67] sm:text-lg"
                    >
                        Atención especializada para diferentes necesidades de
                        comunicación, habla, voz, deglución y audición.
                    </motion.p>
                </motion.div>
                            ...
                            >
                                <Dialog>
                                    <DialogTrigger asChild>
                                        <button
                                            type="button"
                                            className={`group relative flex h-full w-full cursor-pointer flex-col overflow-hidden rounded-[28px] border bg-white p-7 text-left outline-none transition-all duration-300 hover:shadow-[0_20px_50px_rgba(85,72,74,0.08)] focus-visible:ring-2 focus-visible:ring-[#d99aa8] ${
                                                isPink
                                                    ? 'border-[#d99aa8]/20'
                                                    : 'border-[#7d8f7a]/20'
                                            }`}
                                        >
                                            ...
                                            <div
                                                className={`mb-8 flex size-14 items-center justify-center rounded-2xl transition-all duration-300 group-hover:scale-105 group-hover:rotate-2 ${
                                                    isPink
                                                        ? 'bg-[#d99aa8]/12 text-[#c98796]'
                                                        : 'bg-[#7d8f7a]/12 text-[#6f826c]'
                                                }`}
                                            >
                                                <Icon
                                                    className="size-6"
                                            ...
                                            {/* Content */}
                                            <h3 className="max-w-[250px] text-xl font-semibold tracking-[-0.02em] text-[#373432]">
                                                {service.title}
                                            </h3>

                                            <p className="mt-3 text-sm leading-6 text-[#706a67]">
                                    ...
                                    <DialogContent className="max-h-[90vh] overflow-y-auto rounded-[28px] border-[#d99aa8]/20 bg-[#fcf9f7] sm:max-w-lg">
                                        <DialogHeader className="text-left">
                                            ...
                                            <DialogTitle className="text-2xl tracking-[-0.02em] text-[#373432]">
                                                {service.title}
                                            </DialogTitle>
                                        ...
                                        {service.details.length > 0 && (
                                            <div className="mt-5">
                                                <h4 className="mb-4 text-sm font-bold tracking-wide text-[#55484a]">
                                                ...
                                                <ul className="space-y-3">
                                                    {service.details.map(
                                                        (detail) => (
                                                            <li
                                                                key={detail}
                                                                className="flex gap-3 text-sm leading-6 text-[#706a67]"
                                                            >
                                                                <span
                ...
                >
                    ...
                    <p className="text-sm text-[#706a67]">
                        ...
                        <span className="font-semibold text-[#55484a]">
                            La atención también.
                        </span>
                    </p>
